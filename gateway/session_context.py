...
_CRON_EXECUTION_SOURCE: ContextVar = ContextVar("HERMES_CRON_EXECUTION_SOURCE", default=_UNSET)
_CRON_SCHEDULED_FOR: ContextVar = ContextVar("HERMES_CRON_SCHEDULED_FOR", default=_UNSET)
_CRON_DELIVERY_TARGETS_JSON: ContextVar = ContextVar("HERMES_CRON_DELIVERY_TARGETS_JSON", default=_UNSET)
...
_VAR_MAP = {
    ...
    "HERMES_CRON_EXECUTION_SOURCE": _CRON_EXECUTION_SOURCE,
    "HERMES_CRON_SCHEDULED_FOR": _CRON_SCHEDULED_FOR,
    "HERMES_CRON_DELIVERY_TARGETS_JSON": _CRON_DELIVERY_TARGETS_JSON,
}
